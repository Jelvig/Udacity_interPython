class Customer:
# my code is below
    def __init__(self, first_name: str, last_name: str, tier: tuple = ("free", 0)): # free or premium so a tuple is used for 0 or 10$
...
# code that was provided to prove my answer
